  ...
  return (
    <div className="flex flex-col h-full" style={{ background: 'var(--bg)' }}>
      ...
      <div
        ...
        style={{ paddingTop: `calc(env(safe-area-inset-top) + 16px)`, paddingBottom: 16, background: 'var(--bg)' }}
      >
        <button
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
            <path d="M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6" stroke="var(--score-low)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
      </div>
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-6 text-center">
            ...
            >
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
                ...
                <circle cx="12" cy="13" r="4" stroke="var(--accent)" strokeWidth="1.8" />
              </svg>
            </div>
          ...
          <div className="fade-in space-y-6">
              ...
              >
                ...
                {lastScan.strengths.map((s, i) => (
                  <div key={i} className="flex gap-3">
                    <span className="w-2 h-2 rounded-full mt-1.5 flex-shrink-0" style={{ background: 'var(--score-high)' }} />
              ...
              >
                ...
                {lastScan.weaknesses.map((w, i) => (
                  <div key={i} className="flex gap-3">
                    ...
                    <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>{w}</p>
                  </div>
                ))}
              </div>
            )}
            ...
            {lastScan.productSuggestions.length > 0 && (
              <div>
                ...
                <div className="flex gap-3 overflow-x-auto pb-2 -mx-5 px-5 scroll-area" style={{ scrollSnapType: 'x mandatory' }}>
                  {lastScan.productSuggestions.map((p, i) => (
                    <div key={`${p.asin}-${i}`} style={{ scrollSnapAlign: 'start' }}>
      ...
      {/* Action buttons */}
      <div
        className="px-5 pb-6 safe-bottom flex gap-3"
