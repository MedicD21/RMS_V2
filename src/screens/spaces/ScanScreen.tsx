...
export function ScanScreen() {
  ...
  async function runAnalysis(dataUrl: string, localUri: string) {
    ...
    try {
      ...
      const productPromises = analysis.productCategories.slice(0, 3).map((cat) =>
        mockAmazonAdapter.searchProducts(cat, 2)
      )
      ...
      const products = productGroups.flat().filter((p) => {
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 gap-6">
        ...
        <div className="text-center">
          ...
          <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            Take a clear photo of your room. Make sure the whole space is visible for the best analysis.
          </p>
        </div>
