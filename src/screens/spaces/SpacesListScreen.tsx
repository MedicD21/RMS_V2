    ...
    <div className="flex flex-col items-center justify-center h-full gap-6 px-8 text-center">
      ...
      <div>
        ...
        <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          Add your first space to start tracking and improving your organization.
        </p>
      </div>
      <button
        onClick={onAdd}
    ...
    <div className="flex flex-col h-full" style={{ background: 'var(--bg)' }}>
      ...
      {spaces.length > 0 && (
        <button
          ...
          className="absolute bottom-24 right-5 w-14 h-14 rounded-full flex items-center justify-center shadow-lg active:opacity-70 transition-opacity"
