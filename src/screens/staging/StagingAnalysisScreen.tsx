        ...
        <div className="flex-1 flex flex-col items-center justify-center px-5 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
              Take a wide photo showing the full room. Good lighting makes for better staging advice.
            </p>
          </div>
      ...
      <div className="flex flex-col h-full items-center justify-center" style={{ background: 'var(--bg)' }}>
        {photoDataUrl && (
          <div className="w-full max-w-sm px-5 mb-6">
            <img src={photoDataUrl} alt="Room" className="w-full rounded-2xl object-cover" style={{ maxHeight: 220 }} />
          </div>
        )}
